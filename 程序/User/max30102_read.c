...
int32_t spo2_buf[16];
int32_t spo2Sum;
extern int32_t blood_oxygen_concentration;
					...
					if ((ch_spo2_valid == 1) && (n_spo2 > 80))
					{
							...
							if (spo2ThrowOutSamp == 0)
							{
									...
									else if (spo2BuffFilled < 4)
									{
											...
											blood_oxygen_concentration = spo2Sum >> 1;
									}
									else if (spo2BuffFilled < 8)
									{
											...
											blood_oxygen_concentration = spo2Sum >> 2;
									}
									else if (spo2BuffFilled < 16)
									{
											...
											blood_oxygen_concentration = spo2Sum >> 3;
									}
									else
									{
											for(i = 0; i < 16; i++)
											...
											blood_oxygen_concentration = spo2Sum >> 4;
									}
							}
							spo2ThrowOutSamp = 0;
					}
